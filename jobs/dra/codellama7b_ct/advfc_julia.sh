...
OUTPUT_DIR="/scratch/amirresm/outputs/advfusion/codellama7b_ct/advfc_${lang}"
mkdir -p "$OUTPUT_DIR"
...
target_adapter_path="/scratch/amirresm/outputs/advfusion/codellama7b_ct/compacter_${lang}"

adapter_path_list=(
	"/scratch/amirresm/outputs/advfusion/codellama7b_ct/compacter_julia"
	"/scratch/amirresm/outputs/advfusion/codellama7b_ct/compacter_ruby"
	"/scratch/amirresm/outputs/advfusion/codellama7b_ct/compacter_scala"
	"/scratch/amirresm/outputs/advfusion/codellama7b_ct/compacter_swift"
)
